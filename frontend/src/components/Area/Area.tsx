...
const CANVAS_COLOR_SECONDARY = '#808185';
const CANVAS_COLOR_BACKGROUND = '#C0C0C0';
const CANVAS_COLOR_SHADOW = 'rgba(0, 0, 0, 0.5)';
const CANVAS_COLOR_AREA = '#006eff';
const CANVAS_COLOR_POINT_OTHER = '#333333';
const CANVAS_COLOR_POINT_INCLUDES = '#54ff3a';
const CANVAS_COLOR_POINT_NOT_INCLUDES = '#ff272d';
...
export class Area extends React.Component<AreaProps, AreaState> {
    ...
    public repaint() {
        ...
        context.arc(CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2, Math.abs((CANVAS_STEP_X + CANVAS_STEP_Y) / 2 * halfR), 3 * Math.PI/2, 0, false);
        context.arc(CANVAS_WIDTH / 2, CANVAS_HEIGHT / 2, Math.abs((CANVAS_STEP_X + CANVAS_STEP_Y) / 2 * halfR), Math.PI/2, Math.PI, false);
